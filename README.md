...
- [x] **WordPress:** ACF, Gutenberg, Elementor and Crocoblock, Bricks, WP All Import, Tutor LMS, WPML, Polylang, Yoast SEO, WP Rocket, WPvivid, Qubely, Kadence Blocks, WP All Migration, Duplicator.
- [x] Popular WP themes: WoodMart, Kadence, Blocksy, Hello.
- [x] Local web servers: Laragon, Local WP.<br>
- [x] SEO: On-page SEO, Ahrefs, Serpstat, Keys.so, Screaming Frog, Google Search Console, Google Analytics, Google Tag Manager and other.<br>
- [x] Project management/planning: Notion, Nimbus, Trello, Perfex CRM, Todoist.<br>
- [x] Soft: Content Downloader (parsing), ZennoPoster (process automation).
- [x] FTP-clients: WinSCP, FileZilla.
